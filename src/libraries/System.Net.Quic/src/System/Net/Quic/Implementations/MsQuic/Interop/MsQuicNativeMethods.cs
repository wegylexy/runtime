...
namespace System.Net.Quic.Implementations.MsQuic.Internal
{
    ...
    internal static unsafe class MsQuicNativeMethods
    {
        ...
        internal struct CredentialConfig
        {
            ...
            internal delegate* unmanaged<IntPtr, IntPtr, uint, void> AsyncHandler; // optional, must set LOAD_ASYNCHRONOUS flag.
        }

        [StructLayout(LayoutKind.Sequential)]
        internal struct CredentialConfigCertificateFile
        {
            internal IntPtr PrivateKeyFile;
            internal IntPtr CertificateFile;
        }
